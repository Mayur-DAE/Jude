...
namespace DAE.DAL.SQL
{
    ...
    public class DBUtility
    {
        ...
        /// </summary>
        public DBUtility(IDaeConfigManager configuration)
        {
            _htParamCollection = new Hashtable();
            _htParamOutPut = new Hashtable();
            this._configuration = configuration;
            // var myKeyValue = Configuration["ConnectionStrings"];
        }
       ...
       ///        
        ...
        
        {
            try
            {
                ...
                //string sConnectString = oCustomConfiguration.CommonSettings.ConnectionString;


                string sConnectString = this._configuration.AreaOnlineCS;
        ...
        public DataSet Execute_StoreProc_DataSet(string psStoreProcName)
        {
            ...
            {
                objConnection = GetConnection();
                //objConnection = new SqlConnection("Data Source=LAPTOP-EUO3BRVG\\SQLEXPRESS; Initial Catalog = EmployeeDB; Integrated Security =true");
                objCommand = new SqlCommand(psStoreProcName, objConnection);
                objCommand.CommandType = CommandType.StoredProcedure;
